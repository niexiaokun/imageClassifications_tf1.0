...
if __name__ == "__main__":
    ...
    with tf.device('/cpu:0'):
        with slim.arg_scope(mobilenet_v1_arg_scope()):
            logits, end_points = mobilenet_v1(inputs, 1001, is_training=True)
    pprint(end_points)
    init_fn = slim.assign_from_checkpoint_fn(
        "/media/kun/4DDAE1651159A0A8/tf_object_models/mobilenet-v1-1.0-224-tf/mobilenet_v1_1.0_224.ckpt",
    ...
    # with tf.Session() as sess:
    #     tf.train.import_meta_graph("/media/kun/4DDAE1651159A0A8/tf_object_models/mobilenet-v2-1.0-224/mobilenet_v2_1.0_224.ckpt.meta",
    #                                clear_devices=True)
